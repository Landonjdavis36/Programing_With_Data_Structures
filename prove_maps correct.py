...
def is_anagram(word1, word2):
    ...
    try:
        word1_temp = word1.split(" ")
        for part in word1_temp:
            word_one += part.lower()
    except:
        word_one = word1.lower()
    try:
        word2_temp = word2.split(" ")
        for part in word2_temp:
            word_two += part.lower()
    except:
        word_two = word2.lower()
        # make sure that both words have the same number of letter
    if len(word_one) == len(word_two):
        ...
        for letter in word_one:
            ...
            if letter in letters1:
                letters1[letter] += 1
                # add it to the dictionary of the word if it doesn.t already exists
            else:
                letters1[letter] = 1
...
def earthquake_daily_summary():
    ...
    for place in data['features']:
        print(place['properties']['place'],"-mag", place['properties']['mag'])
